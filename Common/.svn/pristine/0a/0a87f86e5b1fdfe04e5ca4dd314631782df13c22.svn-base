...
public class Scf1501Request implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5400067454352480435L;
	...
	// 商户端用户ID
	@NotBlank(message="商户端用户ID不能为空,且不超过32位")
	@Length(max=32,message="商户端用户ID不超过32位")
	
	private String merchantUserId;

	// 系统流水号
	@NotBlank(message="系统流水号不能为空,且不超过32位")
