...
public class Finance1012Request implements Serializable  {
	...
	private String coOwnAndGuarantee;
	...
	public String getCoOwnAndGuarantee() {
		return coOwnAndGuarantee;
	}
	public void setCoOwnAndGuarantee(String coOwnAndGuarantee) {
		this.coOwnAndGuarantee = coOwnAndGuarantee;
	}
