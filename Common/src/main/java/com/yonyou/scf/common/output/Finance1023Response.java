...
public class Finance1023Response  implements Serializable {
	...
	public Long getInvoiceBillingId() {
		return invoiceBillingId;
	}
	public void setInvoiceBillingId(Long invoiceBillingId) {
