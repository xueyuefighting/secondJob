package com.yonyou.scf.userFace.util;
...
public class VerifyCodeUtils {
	...
	public static String SEED = "0123456789";
...
//		String key = currentTime+randomSixStr(SEED,6);
		String key = UUID.randomUUID().toString();//36位uuid  带‘-’的
		return key;
	}
//    public static void main(String[] args) throws IOException{
//    	 	long time = System.currentTimeMillis();
//        File dir = new File("/Users/wyx/Documents");
//        int w = 200, h = 80;
...
//            System.out.println("生成结束，总耗时："+(time-time1)+"ms");
//    }
}
