package com.yonyou.scf.userFace;
...
@MapperScan(basePackages = { "com.yonyou.scf.common.mapper.auto","com.yonyou.scf.userFace.mapper" })
//@MapperScan("com.yonyou.scf.*.mapper*")  
...
public class App {
	...
	private static void head() {
		...
		System.out.println("userFace startup successfully !");
		System.out.println("===========================================");
	}
}
