...
@MapperScan(basePackages = { "com.yonyou.scf.common.mapper.auto","com.yonyou.scf.user.mapper" })
...
public class App {
	...
	private static void head() {
		...
		System.out.println("user startup successfully !");
		System.out.println("===========================================");
	}
}
